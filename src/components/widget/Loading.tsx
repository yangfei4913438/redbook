...
export default class Loading {
  ...
  static show(textContent = LoadingOptions.text && LoadingOptions.text.length > 0 ? LoadingOptions.text : '加载中...') {
    ...
    const loadingViewBackgroundColor =
      LoadingOptions.loadingViewStyle && LoadingOptions.loadingViewStyle.backgroundColor
      ...
      >
        ...
        >
          {LoadingOptions.loadingImage ? (
            ...
            <ActivityIndicator color={'#fff'} animating={true} style={{ marginTop: 10 }} size="large" />
          )}
          <Text
            style={[
              {
